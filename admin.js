...
var DEFAULT_ADMIN_PRODUCTS = {
    pria: [
        ...
        { id: 'p5', name: 'Essential Black Bomber Jacket', brand: 'H&M', price: 799000, img: 'https://via.placeholder.com/520x680?text=Bomber+Jacket', cat: 'apparel' },
        { id: 'p6', name: 'Tailored Navy Chino Pants', brand: 'UNIQLO', price: 549000, img: 'https://via.placeholder.com/520x680?text=Chino+Pants', cat: 'apparel' },
        { id: 'p7', name: 'Soft Cotton Polo Shirt', brand: 'ZARA MAN', price: 399000, img: 'men_shirt_product_1780400575906.png', cat: 'apparel' },
        { id: 'p8', name: 'Vintage Indigo Denim Overshirt', brand: 'LEVI’S', price: 999000, img: 'https://via.placeholder.com/520x680?text=Denim+Overshirt', cat: 'apparel' },
        { id: 'p9', name: 'Stretch Performance Jogger Pants', brand: 'NIKE', price: 649000, img: 'https://via.placeholder.com/520x680?text=Jogger+Pants', cat: 'apparel' }
    ],
    wanita: [
